...
const Home3 = () => {
  return (
    <div className="relative bg-gradient-to-tr from-indigo-50 via-purple-50 to-blue-50">
  ...
  {/* Features Section */}
  <div className="relative bg-white/70 backdrop-blur-sm shadow-sm py-24 sm:py-32 rounded-3xl mx-4 sm:mx-8">
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      {/* Footer Section */}
      <footer className="bg-white border-t border-black-200 py-10 mt-10">
